...
1. **读取VIN码获取flag** (DID: `0xF190`)
2. **通过安全访问级别1读取DID：0xC1C2获取flag**  (DID: `0xC1C2`)
3. **通过安全访问级别3读取DID：0xD1D2获取flag** (DID: `0xD1D2`)
4. **通过安全访问级别5读取内存获取flag** (0x23服务)
5. **系统启动时会往外发送flag，复位即可获取flag** (CAN ID: `0x7E8`)
